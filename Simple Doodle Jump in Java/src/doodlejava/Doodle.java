...
public class Doodle extends OSprite {
    ...
    public static final Image DOODLE_RIGHT = mulaifatanalkayyisa.getImage("doodleR.png");
    public static final Image DOODLE_LEFT = mulaifatanalkayyisa.getImage("doodleL.png");
