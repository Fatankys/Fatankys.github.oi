...
public class GamePanel extends OSprite {
    ...
    static {
        SoundManager.add("jump", mulaifatanalkayyisa.getSoundFile("jump.wav"));
        SoundManager.add("fall", mulaifatanalkayyisa.getSoundFile("pada.wav"));
    }
    ...
    public GamePanel(Dimension size) {
        super(mulaifatanalkayyisa.getImage("bg.png"));
        this.setSize(size);
